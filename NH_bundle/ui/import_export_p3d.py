...
class NH_OP_import_p3d(bpy.types.Operator, bpy_extras.io_utils.ImportHelper):
    """Import Arma 3 MLOD P3D"""
    
    bl_idname = "nh.import_p3d"
    bl_label = "Import P3D"
...
class NH_PT_import_p3d_main(bpy.types.Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "NH_OT_import_p3d"
...
class NH_PT_import_p3d_collections(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
...
class NH_PT_import_p3d_data(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Data"
    bl_parent_id = "FILE_PT_operator"
...
class NH_PT_import_p3d_post(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
...
class NH_OP_export_p3d(bpy.types.Operator, bpy_extras.io_utils.ExportHelper):
    """Export to Arma 3 MLOD P3D"""
    
    bl_idname = "nh.export_p3d"
    bl_label = "Export P3D"
    bl_options = {'REGISTER', 'UNDO', 'PRESET'}
    filename_ext = ".p3d"
...
class NH_PT_export_p3d_main(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Include"
    bl_parent_id = "FILE_PT_operator"
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "NH_OT_export_p3d"
...
class NH_PT_export_p3d_include(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Include"
    bl_parent_id = "FILE_PT_operator"
...
class NH_PT_export_p3d_meshes(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Mesh Data"
    bl_parent_id = "FILE_PT_operator"
...
class NH_PT_export_p3d_post(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Postprocess"
    bl_parent_id = "FILE_PT_operator"
...
classes = (
    NH_OP_import_p3d,
    NH_PT_import_p3d_main,
    NH_PT_import_p3d_collections,
    NH_PT_import_p3d_data,
    NH_PT_import_p3d_post,
    NH_OP_export_p3d,
    NH_PT_export_p3d_main,
    NH_PT_export_p3d_include,
    NH_PT_export_p3d_meshes,
    NH_PT_export_p3d_validate,
    NH_PT_export_p3d_post
)
...
if bpy.app.version >= (4, 1, 0):
    ...
    classes = (*classes, NH_FH_import_p3d)
