...
class NH_OT_proxy_add(bpy.types.Operator):
    """Add an Arma 3 proxy object and parent to the active object"""
    
    bl_idname = "nh.proxy_add"
    bl_label = "Add Proxy"
    bl_options = {'REGISTER'}
...
class NH_OT_proxy_remove(bpy.types.Operator):
    """Remove an Arma 3 proxy object from the active object"""

    bl_idname = "nh.proxy_remove"
...
class NH_OT_paste_common_proxy(bpy.types.Operator):
    """Paste a common proxy model path"""
    
    bl_idname = "nh.paste_common_proxy"
    ...
    def draw(self, context):
        ...
        layout = self.layout
        layout.template_list("NH_UL_common_data_proxies", "A3OB_proxies_common", scene_props, "items", scene_props, "items_index", item_dyntip_propname="value")
...
class NH_OT_namedprops_add(bpy.types.Operator):
    """Add named property to the active object"""
    
    bl_idname = "nh.namedprops_add"
...
class NH_OT_namedprops_remove(bpy.types.Operator):
    """Remove named property from the active object"""
    
    bl_idname = "nh.namedprops_remove"
...
class NH_OT_paste_common_namedprop(bpy.types.Operator):
    """Add a common named property"""
    
    bl_label = "Paste Common Named Property"
    bl_idname = "nh.paste_common_namedprop"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def draw(self, context):
        scene_props = context.scene.a3ob_commons
        layout = self.layout
        layout.template_list("NH_UL_common_data_namedprops", "A3OB_common_namedprops", scene_props, "items", scene_props, "items_index")
...
class NH_OT_lod_copy_add(bpy.types.Operator):
    """Add copy directive to active object"""
    
    bl_idname = "nh.lod_copy_add"
    bl_label = "Add Copy"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_lod_copy_remove(bpy.types.Operator):
    """Remove copy directive from the active object"""
    
    bl_idname = "nh.lod_copy_remove"
...
class NH_OT_flags_vertex_remove(bpy.types.Operator):
    """Remove the active vertex flag group from the active object"""
    
    bl_idname = "nh.flags_vertex_remove"
...
class NH_OT_flags_vertex_assign(bpy.types.Operator):
    """Assign selected vertices to the active vertex flag group"""
    
    bl_label = "Assign"
    bl_idname = "nh.flags_vertex_assign"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_vertex_select(bpy.types.Operator):
    """Select all vertices assigned to the active vertex flag group"""
    
    bl_label = "Select"
    bl_idname = "nh.flags_vertex_select"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_vertex_deselect(bpy.types.Operator):
    """Deselect all selected vertices assigned to the active vertex flag group"""
    
    bl_label = "Deselect"
    bl_idname = "nh.flags_vertex_deselect"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_vertex_clear(bpy.types.Operator):
    """Clear all vertex flag groups from the active object"""
    
    bl_label = "Clear"
    bl_idname = "nh.flags_vertex_clear"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_face_remove(bpy.types.Operator):
    """Remove the active face flag group from the active object"""
    
    bl_idname = "nh.flags_face_remove"
...
class NH_OT_flags_face_assign(bpy.types.Operator):
    """Assign selected vertices to the active face flag group"""
    
    bl_label = "Assign"
    bl_idname = "nh.flags_face_assign"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_face_select(bpy.types.Operator):
    """Select all vertices assigned to the active face flag group"""
    
    bl_label = "Select"
    bl_idname = "nh.flags_face_select"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_face_deselect(bpy.types.Operator):
    """Deselect all selected vertices assigned to the active face flag group"""
    
    bl_label = "Deselect"
    bl_idname = "nh.flags_face_deselect"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_OT_flags_face_clear(bpy.types.Operator):
    """Clear all face flag groups from the active object"""
    
    bl_label = "Clear"
    bl_idname = "nh.flags_face_clear"
    bl_options = {'REGISTER', 'UNDO'}
...
class NH_UL_namedprops(bpy.types.UIList):
...
class NH_UL_lod_copies(bpy.types.UIList):
...
class NH_UL_common_proxies(bpy.types.UIList):
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        layout.label(text=item.name)


class NH_UL_flags_vertex(bpy.types.UIList):
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        layout.prop(item, "name", text="", emboss=False)
        layout.label(text=("%08x" % item.get_flag()))


class NH_UL_flags_face(bpy.types.UIList):
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        layout.prop(item, "name", text="", emboss=False)
        layout.label(text=("%08x" % item.get_flag()))


class NH_UL_proxy_access(bpy.types.UIList):
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        row = layout.row(align=True)
        op = row.operator("nh.select_object", text="", icon='RESTRICT_SELECT_OFF', emboss=False)
...
class NH_PT_object_mesh(bpy.types.Panel):
...
class NH_PT_object_mesh_namedprops(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
    bl_label = "Named Properties"
    bl_context = "data"
    bl_parent_id = "NH_PT_object_mesh"
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        row = layout.row()
        col_list = row.column()
        col_list.template_list("NH_UL_namedprops", "A3OB_namedprops", object_props, "properties", object_props, "property_index")
            
        col_operators = row.column(align=True)
        col_operators.operator("nh.namedprops_add", text="", icon='ADD')
        col_operators.operator("nh.namedprops_remove", text="", icon='REMOVE')
        col_operators.separator()
        col_operators.operator("nh.paste_common_namedprop", icon='PASTEDOWN', text="")


class NH_PT_object_mesh_proxies(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
    ...
    def draw(self, context):
        ...
        row = layout.row()
        col_list = row.column()
        col_list.template_list("NH_UL_proxy_access", "A3OB_proxy_access", scene_props, "proxies", scene_props, "proxies_index")

        col_operators = row.column(align=True)
        op_add = col_operators.operator("nh.proxy_add", text="", icon='ADD')
        op_add.parent = context.object.name
        op_remove = col_operators.operator("nh.proxy_remove", text="", icon='REMOVE')
...
class NH_PT_object_mesh_copies(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        col_list = row.column()
        col_list.template_list("NH_UL_lod_copies", "A3OB_lod_copies", object_props, "copies", object_props, "copies_index")
            
        col_operators = row.column(align=True)
        col_operators.operator("nh.lod_copy_add", text="", icon='ADD')
        col_operators.operator("nh.lod_copy_remove", text="", icon='REMOVE')


class NH_PT_object_mesh_flags(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
...
class NH_PT_object_mesh_flags_vertex(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
    bl_label = "Vertex Flag Groups"
    bl_context = "data"
    bl_parent_id = "NH_PT_object_mesh_flags"
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        row = layout.row()
        col_list = row.column()
        col_list.template_list("NH_UL_flags_vertex", "A3OB_flags_vertex", flag_props, "vertex", flag_props, "vertex_index")
        ...
        if utils.is_valid_idx(flag_props.vertex_index, flag_props.vertex):
            if obj.mode == 'EDIT':
                ...
                row_operators.operator("nh.flags_vertex_assign")
                row_operators.operator("nh.flags_vertex_select")
                row_operators.operator("nh.flags_vertex_deselect")
        ...
        col_operators = row.column(align=True)
        col_operators.operator("nh.flags_vertex_add", text="", icon='ADD')
        col_operators.operator("nh.flags_vertex_remove", text="", icon='REMOVE')
        col_operators.separator()
        col_operators.operator("nh.flags_vertex_clear", text="", icon='TRASH')


class NH_PT_object_mesh_flags_face(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
    ...
    def draw(self, context):
        ...
        row = layout.row()
        col_list = row.column()
        col_list.template_list("NH_UL_flags_face", "A3OB_flags_face", flag_props, "face", flag_props, "face_index")
        ...
        if utils.is_valid_idx(flag_props.face_index, flag_props.face):
            if obj.mode == 'EDIT':
                row_operators = layout.row(align=True)
                row_operators.operator("nh.flags_face_assign")
                row_operators.operator("nh.flags_face_select")
                row_operators.operator("nh.flags_face_deselect")
        ...
        col_operators = row.column(align=True)
        col_operators.operator("nh.flags_face_add", text="", icon='ADD')
        col_operators.operator("nh.flags_face_remove", text="", icon='REMOVE')
        col_operators.separator()
        col_operators.operator("nh.flags_face_clear", text="", icon='TRASH')


class NH_PT_object_proxy(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
    ...
    def draw(self, context):
        ...
        op = row_select.operator("nh.select_object", text="Select Parent LOD", icon='RESTRICT_SELECT_OFF')
        ...
        row_path.operator("nh.paste_common_proxy", text="", icon='PASTEDOWN')
        row_path.prop(object_props, "proxy_path", text="", icon='MESH_CUBE')
        layout.prop(object_props, "proxy_index")


class NH_PT_object_dtm(bpy.types.Panel):
    bl_region_type = 'WINDOW'
    bl_space_type = 'PROPERTIES'
...
def menu_func(self, context):
    ...
    self.layout.operator(NH_OT_proxy_add.bl_idname, text="Arma 3 Proxy", icon_value=get_icon("op_proxy_add"))


classes = (
    NH_OT_proxy_add,
    NH_OT_proxy_remove,
    NH_OT_paste_common_proxy,
    NH_OT_namedprops_add,
    NH_OT_namedprops_remove,
    NH_OT_paste_common_namedprop,
    NH_OT_lod_copy_add,
    NH_OT_lod_copy_remove,
    NH_OT_flags_vertex_add,
    NH_OT_flags_vertex_remove,
    NH_OT_flags_vertex_assign,
    NH_OT_flags_vertex_select,
    NH_OT_flags_vertex_deselect,
    NH_OT_flags_vertex_clear,
    NH_OT_flags_face_add,
    NH_OT_flags_face_remove,
    NH_OT_flags_face_assign,
    NH_OT_flags_face_select,
    NH_OT_flags_face_deselect,
    NH_OT_flags_face_clear,
    NH_UL_namedprops,
    NH_UL_lod_copies,
    NH_UL_common_proxies,
    NH_UL_flags_vertex,
    NH_UL_flags_face,
    NH_UL_proxy_access,
    NH_PT_object_mesh,
    NH_PT_object_mesh_namedprops,
    NH_PT_object_mesh_proxies,
    NH_PT_object_mesh_copies,
    NH_PT_object_proxy,
    NH_PT_object_mesh_flags,
    NH_PT_object_mesh_flags_vertex,
    NH_PT_object_mesh_flags_face,
    NH_PT_object_dtm
)
