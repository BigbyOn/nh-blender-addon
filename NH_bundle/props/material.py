...
class NH_PG_properties_material(bpy.types.PropertyGroup):
...
def register():
    ...
    bpy.types.Material.a3ob_properties_material = bpy.props.PointerProperty(type=NH_PG_properties_material)
