...
class NH_PG_outliner_proxy(bpy.types.PropertyGroup):
    obj: bpy.props.StringProperty(name="Object Name")
    name: bpy.props.StringProperty(name="Proxy Type")


class NH_PG_outliner_lod(bpy.types.PropertyGroup):
    obj: bpy.props.StringProperty(name="Object Name")
...
class NH_PG_outliner(bpy.types.PropertyGroup):
    show_hidden: bpy.props.BoolProperty(name="Show Hidden Objects")
    lods: bpy.props.CollectionProperty(type=NH_PG_outliner_lod)
    lods_index: bpy.props.IntProperty(name="Selection Index")
    proxies: bpy.props.CollectionProperty(type=NH_PG_outliner_proxy)
...
class NH_PG_proxy_access(bpy.types.PropertyGroup):
    proxies: bpy.props.CollectionProperty(type=NH_PG_outliner_proxy)
    proxies_index: bpy.props.IntProperty(name="Selection Index")


class NH_PG_lod_object(bpy.types.PropertyGroup):
    name: bpy.props.StringProperty(name="Object Name")
    lod: bpy.props.StringProperty(name="LOD type")
    enabled: bpy.props.BoolProperty(name="Enabled")


class NH_PG_proxies(bpy.types.PropertyGroup):
    lod_objects: bpy.props.CollectionProperty(type=NH_PG_lod_object)
    lod_objects_index: bpy.props.IntProperty(name="Selection Index")


class NH_PG_common_data_item(bpy.types.PropertyGroup):
...
class NH_PG_common_data(bpy.types.PropertyGroup):
    items: bpy.props.CollectionProperty(type=NH_PG_common_data_item)
    items_index: bpy.props.IntProperty(name="Selection Index")


class NH_PG_mass_editor_stats(bpy.types.PropertyGroup):
...
class NH_PG_mass_editor(bpy.types.PropertyGroup):
    ...
    stats: bpy.props.PointerProperty(type=NH_PG_mass_editor_stats)


class NH_PG_hitpoint_generator(bpy.types.PropertyGroup):
...
class NH_PG_validation(bpy.types.PropertyGroup):
...
class NH_PG_conversion(bpy.types.PropertyGroup):
...
class NH_PG_renamable(bpy.types.PropertyGroup):
    path: bpy.props.StringProperty(name = "From", description = "File path")


class NH_PG_renaming(bpy.types.PropertyGroup):
    ...
    path_list: bpy.props.CollectionProperty(type=NH_PG_renamable)
...
class NH_PG_colors(bpy.types.PropertyGroup):
...
class NH_PG_rigging_bone(bpy.types.PropertyGroup):
...
class NH_PG_rigging_skeleton(bpy.types.PropertyGroup):
    ...
    bones: bpy.props.CollectionProperty(type=NH_PG_rigging_bone)
    bones_index: bpy.props.IntProperty(name="Selection Index")


class NH_PG_rigging(bpy.types.PropertyGroup):
    skeletons: bpy.props.CollectionProperty(type=NH_PG_rigging_skeleton)
    skeletons_index: bpy.props.IntProperty(name="Active Skeleton Index", description="Double click to rename")
    bones: bpy.props.CollectionProperty(type=NH_PG_rigging_bone) # empty collection to show when no skeleton is selected
...
class NH_PG_materials_template(bpy.types.PropertyGroup):
    name: bpy.props.StringProperty()
    path: bpy.props.StringProperty()


class NH_PG_materials(bpy.types.PropertyGroup):
    templates: bpy.props.CollectionProperty(type=NH_PG_materials_template)
...
classes = (
    NH_PG_outliner_proxy,
    NH_PG_outliner_lod,
    NH_PG_outliner,
    NH_PG_lod_object,
    NH_PG_proxies,
    NH_PG_common_data_item,
    NH_PG_common_data,
    NH_PG_mass_editor_stats,
    NH_PG_mass_editor,
    NH_PG_hitpoint_generator,
    NH_PG_validation,
    NH_PG_conversion,
    NH_PG_renamable,
    NH_PG_renaming,
    NH_PG_colors,
    NH_PG_rigging_bone,
    NH_PG_rigging_skeleton,
    NH_PG_rigging,
    NH_PG_proxy_access,
    NH_PG_materials_template,
    NH_PG_materials
)
...
def register():
    ...
    bpy.types.Scene.a3ob_outliner = bpy.props.PointerProperty(type=NH_PG_outliner)
    bpy.types.Scene.a3ob_proxies = bpy.props.PointerProperty(type=NH_PG_proxies)
    bpy.types.Scene.a3ob_commons = bpy.props.PointerProperty(type=NH_PG_common_data)
    bpy.types.Scene.a3ob_mass_editor = bpy.props.PointerProperty(type=NH_PG_mass_editor)
    bpy.types.Scene.a3ob_hitpoint_generator = bpy.props.PointerProperty(type=NH_PG_hitpoint_generator)
    bpy.types.Scene.a3ob_validation = bpy.props.PointerProperty(type=NH_PG_validation)
    bpy.types.Scene.a3ob_conversion = bpy.props.PointerProperty(type=NH_PG_conversion)
    bpy.types.Scene.a3ob_renaming = bpy.props.PointerProperty(type=NH_PG_renaming)
    bpy.types.Scene.a3ob_rigging = bpy.props.PointerProperty(type=NH_PG_rigging)
    bpy.types.Scene.a3ob_colors = bpy.props.PointerProperty(type=NH_PG_colors)
    bpy.types.Scene.a3ob_proxy_access = bpy.props.PointerProperty(type=NH_PG_proxy_access)
    bpy.types.Scene.a3ob_materials = bpy.props.PointerProperty(type=NH_PG_materials)
