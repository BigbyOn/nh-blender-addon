...
if bl_version >= (3, 3, 0):
    class NH_PG_properties_named_property(bpy.types.PropertyGroup):
...
class NH_PG_properties_flag_vertex(bpy.types.PropertyGroup):
...
class NH_PG_properties_flag_face(bpy.types.PropertyGroup):
...
class NH_PG_properties_lod_copy(bpy.types.PropertyGroup):
...
class NH_PG_properties_object_mesh(bpy.types.PropertyGroup):
    ...
    properties: bpy.props.CollectionProperty(
        ...
        type = NH_PG_properties_named_property
    )
    ...
    copies: bpy.props.CollectionProperty(
        ...
        type = NH_PG_properties_lod_copy
    )
...
class NH_PG_properties_object_flags(bpy.types.PropertyGroup):
    ...
    face: bpy.props.CollectionProperty(
        ...
        type = NH_PG_properties_flag_face
    )
    face_index: bpy.props.IntProperty(name="Active Face Flag Group Index")


class NH_PG_properties_object_proxy(bpy.types.PropertyGroup):
...
class NH_PG_properties_object_dtm(bpy.types.PropertyGroup):
...
classes = (
    NH_PG_properties_named_property,
    NH_PG_properties_flag_vertex,
    NH_PG_properties_flag_face,
    NH_PG_properties_lod_copy,
    NH_PG_properties_object_mesh,
    NH_PG_properties_object_flags,
    NH_PG_properties_object_proxy,
    NH_PG_properties_object_dtm
)
...
def register():
    ...
    bpy.types.Object.a3ob_properties_object = bpy.props.PointerProperty(type=NH_PG_properties_object_mesh)
    bpy.types.Object.a3ob_properties_object_flags = bpy.props.PointerProperty(type=NH_PG_properties_object_flags)
    bpy.types.Object.a3ob_properties_object_proxy = bpy.props.PointerProperty(type=NH_PG_properties_object_proxy)
    bpy.types.Object.a3ob_properties_object_dtm = bpy.props.PointerProperty(type=NH_PG_properties_object_dtm)
